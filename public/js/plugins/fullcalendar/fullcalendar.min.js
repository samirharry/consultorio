...
! function(a) {
  ...
  var ub = Wa.DayTableMixin = {
      ...
      renderHeadDateCellHtml: function(a, b, c) {
        var d = this.view;
        return '<th class="fc-day-header btn-primary ' + d.widgetHeaderClass + " fc-" + $a[a.day()] + '" style="cursor: pointer;" onclick="selectTime('+"'"+ a.day()+"'"+')"' + (1 == this.rowCnt ? ' data-date="' + a.format("YYYY-MM-DD") + '"' : "") + (b > 1 ? ' colspan="' + b + '"' : "") + (c ? " " + c : "") + ">" + ca(a.format(this.colHeadFormat)) + "</th>"
      },
      ...
      renderBgCellHtml: function(a, b) {
        ...
        return d.unshift("fc-day", c.widgetContentClass), '<td class="' + d.join(" ") + '" data-date="' + a.format("YYYY-MM-DD") + '"' + (b ? " " + b : "") + "><button class='btn btn-warning dim'><i class='fa fa-clock-o'></i></button></td>"
      },
